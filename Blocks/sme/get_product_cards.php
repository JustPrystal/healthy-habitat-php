    ...
    <div class="card">
      ...
      <div class="content-wrap">
        ...
        <div class="vote-wrap">
          ...
          <button class="vote-button yes" data-id="<?= $row['id'] ?>" data-vote="up" data-type="<?= $type ?>">
            Yes
          </button>
          <button class="vote-button no" data-id="<?= $row['id'] ?>" data-vote="down" data-type="<?= $type ?>">
            No
          </button>
        </div>
    ...
    <script>
      document.querySelectorAll(".vote-button").forEach(button => {
        button.addEventListener("click", function () {
          ...
          const countSpan = this.closest(".card").querySelector(`.vote-count.${vote} span`);

          fetch('./Blocks/sme/vote.php', {
            method: 'POST',
            ...
            .then(data => {
              if (data.success && countSpan) {
                ...
                alert("⚠️ Something went wrong while voting.");
              }
            });
        });
      });
